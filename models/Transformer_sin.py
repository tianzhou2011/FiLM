    ...
    def __init__(self, configs):
        ...
        self.encoder = Encoder(
            [
                EncoderLayer(
                    AttentionLayer(
#                         SpectralConv1d(in_channels=configs.d_model, out_channels=configs.d_model, seq_len=self.seq_len, modes1=configs.modes1),
...
#                         SpectralConv1d(in_channels=configs.d_model, out_channels=configs.d_model, seq_len=self.seq_len, modes1=configs.modes1),
                        configs.d_model, configs.n_heads),
                    AttentionLayer(
#                         SpectralConvCross1d(in_channels=configs.d_model, out_channels=configs.d_model,
